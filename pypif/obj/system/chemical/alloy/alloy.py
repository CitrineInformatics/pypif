...
class Alloy(ChemicalSystem):
    ...
    def __init__(self, names=None, ids=None, chemical_formula=None, composition=None, properties=None,
                 processing=None, phases=None, references=None, contacts=None, licenses=None, **kwargs):
        """
        Constructor.
        ...
        :param processing: List of :class:`.Value` objects with the processing information of the alloy.
        ...
        super(Alloy, self).__init__(names=names, ids=ids, chemical_formula=chemical_formula, composition=composition,
                                    properties=properties, processing=processing, references=references,
